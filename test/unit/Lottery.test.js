...
!developmentChains.includes(network.name)
    ...
    : describe("Lottery Unit Tests", () => {
        ...
        beforeEach(async () => {
            ...
            const vrfCoordinatorV2MockDeployed = await deployments.get("VRFCoordinatorV2_5Mock")
            ...
            it("picks a winner, resets the lottery, and sends money", async () => {
                ...
                await new Promise(async (resolve, reject) => {
                    ...
                    try {
                        ...
                        console.log(await ethers.provider.getBalance(vrfCoordinatorV2Mock.address))
                        // await vrfCoordinatorV2Mock.fundSubscription(4744166381310863501138045196023465007055758975682737987407865132286210751629n, ethers.utils.parseEther("10"))
